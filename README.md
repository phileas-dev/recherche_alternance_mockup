...
To get a FranceTravail API that works with this project, navigate to https://francetravail.io/produits-partages/catalogue/romeo. An account is required. Make sure the ROMEO API is included in your application's permitted APIs.
